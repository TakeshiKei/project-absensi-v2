...
const OutputPage = () => {
  ...
  const fetchData = () => {
    ...
    const apiUrl2 = "http://localhost:5000/api/dataAct";
    ...
    axios
      ...
      .then(
        axios.spread((response1, response2) => {
          ...
          const tidakHadirData = dataUpt.filter((row) => row.absensi !== "Hadir");
          ...
          // You can access the required data from dataAct and update the state accordingly
          const namaKegiatan = dataAct[0].nama_kegiatan;
